...
const AdminHotelsPage = {
    async render(container) {
        ...
        <div class="admin-page">
            ...
            <div class="admin-cards-grid" id="hotels-grid">
                ${hotels.map(h => `
                    ...
                    <div class="admin-card-footer"><span class="badge badge-${h.available ? 'success' : 'warning'}">${h.available ? 'Available' : 'Full'}</span>
        ...
        <div class="modal-backdrop" id="hotel-modal" style="display:none"><div class="modal">
